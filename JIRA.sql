...
CREATE TABLE PROJET (
    ...
    PROJET_STATUS      NUMBER(3) DEFAULT 1 NOT NULL,
...
CREATE TABLE TICKET(
    ...
    TICKET_STATUS   NUMBER(3) DEFAULT 1 NOT NULL,
    TICKET_PRIORITY NUMBER(3) DEFAULT 1 NOT NULL,
    CREATION_DATE   DATE DEFAULT SYSDATE NOT NULL,
    DEADLINE    DATE,
